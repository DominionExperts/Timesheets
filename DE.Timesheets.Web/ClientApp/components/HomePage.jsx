...
class HomePage extends AutobindComponent {
    ...
    render() {
        return <div>
            ...
            <br />
            <p><a href="https://www.pointblankdevelopment.com.au/blog/135/react-redux-with-aspnet-core-20-login-registration-tutorial-example">Security</a></p>
            <p><a href="https://www.youtube.com/watch?v=XLJN4JfniH4">Context</a></p>
        </div>;
    }
}
